...
static unsigned g_uIter = 0;
static unsigned g_uLocalMaxIters = 0;
static FILE *g_fProgress = stderr;
static char g_strFileName[32];
static time_t g_tLocalStart;
static char g_strDesc[32];
